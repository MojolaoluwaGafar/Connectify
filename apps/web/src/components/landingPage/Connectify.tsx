      ...
      <div className="mx-auto w-full max-w-127.5 md:w-6xl md:max-w-none">
        ...
        <div className="w-full flex flex-col md:w-130">
          ...
          <div className="w-full h-auto md:w-130">
            <h2 className="m-0 w-full font-['Fraunces'] font-semibold text-[36px] leading-11 text-[#1C1524] md:w-130 md:text-[36px] md:leading-10">
          ...
          <div className="mt-6 w-full h-auto md:w-130 md:mt-6">
            <p className="m-0 w-full font-['Inter'] font-normal text-[22px] leading-8.25 text-[#6B6178] md:w-130 md:text-[16px] md:leading-6">
          ...
          <div className="mt-9 w-74.75 h-16 md:mt-8 md:w-52.25 md:h-13">
            <button
        ...
        ========================================================= */}
        <div className="relative mx-auto mt-17 w-127.5 h-87.5 md:-mt-62.5 md:ml-145 md:w-130 md:h-95">
          {/* ================= PROFILE IMAGE 1 ================= */}
          {/* 

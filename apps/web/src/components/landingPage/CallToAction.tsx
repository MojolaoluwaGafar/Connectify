...
const CallToAction = () => {
  ...
  return (
    ...
    <section className="w-full px-4 py-5 md:px-0 md:py-14" id="contact">
      ...
      <div className="mx-auto w-full max-w-85.75 h-73 px-6 py-10 rounded-3xl bg-theme flex flex-col items-center gap-4 md:w-3xl md:max-w-none md:h-64 md:px-0 md:py-10 md:rounded-3xl md:gap-3">
        {/* ================= HEADING ================= */}
        {/* Holds the main CTA heading */}
        <div className="w-full h-16 md:w-3xl md:h-10.75">
          {/* Main CTA heading */}
          <h3 className="w-full h-16 mx-auto m-0 font-['Fraunces'] font-semibold text-[26px] leading-8 text-center text-[#FFFFFF] md:w-3xl md:h-10.75 md:text-[36px] md:leading-10.75">
        ...
        <div className="w-full h-16.5 mx-auto md:w-150 md:h-12">
          {/* CTA supporting text */}
          <p className="w-full h-16.5 mx-auto m-0 font-['Inter'] font-normal text-[15px] leading-5.5 text-center text-[#EDE9FE] md:w-150 md:h-12 md:text-[16px] md:leading-6">
        ...
        {/* Button container */}
        <div className="w-full max-w-73.75 h-12.5 mx-auto pt-2 md:w-52.25 md:max-w-none md:h-13 md:pt-0">

  ...
  return (
    <section className="w-full h-124.25 md:h-127 md:w-full lg:w-full flex flex-col items-center gap-6 py-12 px-4 md:gap-5 md:pt-16 md:pr-8 md:pb-20 md:pl-8 bg-linear-to-b from-[#F5F3FF] to-white">
      ...
      <div className="relative flex items-center gap-2 py-1.5 px-6 rounded-[99px] bg-white md:rounded-full">
        ...
        <p className=" text-[12px] leading-4 font-semibold text-[#6D28D9] text-nowrap">
          {' '}
      ...
      <div className="w-full max-w-85.75 h-33 flex items-center justify-center md:w-3xl md:max-w-3xl md:h-38.5 md:pt-1">
        <h1 className="w-full h-33 font-['Fraunces'] font-semibold text-[36px] leading-11 text-center text-[#1C1524] md:w-156 md:h-37.5 md:text-[60px] md:leading-18.75">
      ...
      <div className="w-full max-w-85.75 h-16.5 flex items-center justify-center md:w-xl md:max-w-xl md:h-14">
        {/* Description text */}
        <p className=" w-full h-16.5 text-[15px] leading-5.5 font-['Inter'] font-normal text-[#6B6178] text-center md:w-137.75 md:h-14  md:text-[18px] md:leading-7">
      ...
      <div className="w-full max-w-85.75 h-26 flex flex-col gap-3 md:w-full md:max-w-none md:h-16.5 md:flex-row md:items-center md:justify-center md:gap-3 md:pt-3">
        {/* Get Started button */}
        {/* Get Started button - takes the user to the Sign Up page */}
        <button
          onClick={() => navigate('/signup')}
          className="w-full h-11.5 px-6 py-3 rounded-xl bg-theme md:w-34.25 md:h-13 md:px-6 md:py-3.5"
        >
        ...
        <button
          ...
          className="w-full h-11.5 px-3 py-3 flex items-center justify-center rounded-xl border border-[#1C152426] md:w-23.25 md:h-13.5 md:px-6 md:py-3.5"
        >

...
const ConversationList = ({ onSelectConversation }: ConversationListProps) => {
  ...
  useEffect(() => {
    async function loadConversations() {
      ...
      try {
        ...
        // Guard against a shape mismatch (e.g. { items } vs { data })
        // returning something other than an array.
  ...
  // Drop any conversation whose matched user's profile is missing —
  // otherUser can legitimately be null (matched before completing a
  // profile, or the profile was later deleted) and every field below
  // assumes it exists.
